classdef testAdjointConsistencyTangents < matlab.unittest.TestCase
    % Tests tangent matrices for convection-diffusion-reaction problems 

    methods (Test)
        function testFaceAdjointConsistencyMasterP1(testCase)
            ...
            nu = 1;
            [AL, AR] = face_adjoint_consistency_tangent(master, master, jacobians, jacobians, nu);
        ...
        function testFaceAdjointConsistencyP1(testCase)
            % single element of order 1
